...
N 500 240 610 240 {lab=#net3}
N 610 240 620 240 {lab=#net3}
N 360 220 360 270 {lab=#net4}
N 440 220 620 220 {lab=#net4}
N 920 240 940 240 {lab=out}
N 460 240 460 270 {lab=#net3}
N 460 240 500 240 {lab=#net3}
N 360 220 440 220 {lab=#net4}
...
C {devices/vsource.sym} 570 300 0 0 {name=vbias value=0.8 savecurrent=false}
